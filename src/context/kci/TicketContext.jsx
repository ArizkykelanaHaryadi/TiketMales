...
function parseTicketText(raw) {
  ...
  if (lowerAction.includes("block") && lowerAction.includes("soc")) {
    action = "Block Stellar";
  } else if (lowerAction.includes("menunggu") && lowerAction.includes("konfirmasi")) {
